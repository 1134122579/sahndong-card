...
<template>
  <div class="index-container">
    ...
    <div class="button">
      ...
      <van-button v-if="!isVip" class="buttontext img_animes" round block color="#CE5824" @click="receiveVip"
        >立即领取</van-button
      >
      <van-button v-if="isVip" class="buttontext img_animes" round block color="#CE5824" @click="addCard"
        >立即查看</van-button
      >
    </div>
    <!-- 安全协议 -->
